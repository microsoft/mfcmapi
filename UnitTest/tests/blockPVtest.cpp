...
namespace blockPVtest
{
	...
	public:
		...
		{
			auto propblock = std::wstring(
				L"PropString = cb: 20 lpb: 516B013F8BAD5B4D9A74CAB5B37B588400000006\r\n"
		...
		{
			auto propblock = std::wstring(
				L"PropString = 03:59:00.000 AM 5/10/2020\r\n"
		...
		TEST_METHOD(Test_PT_BOOLEAN)
		{
			...
			testPV(
				...
				0x2);
			testPV(
				L"bool-f-t", PR_MESSAGE_TO_ME, L"01", false, true, L"PropString = True", L"", 0, 0x1);
			testPV(
				L"bool-t-f",
				PR_MESSAGE_TO_ME,
				L"0100000000000000",
