...
namespace propertybag
{
	...
	public:
		...
		SetProp(_In_ LPSPropValue lpProp, _In_ ULONG ulPropTag, const std::wstring& name) = 0;
		virtual _Check_return_ HRESULT DeleteProp(_In_ ULONG ulPropTag, _In_ const std::wstring& name) = 0;
