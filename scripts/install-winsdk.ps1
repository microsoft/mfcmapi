param(
    ...
    [string]$Features = "OptionId.DesktopCPPx64 OptionId.DesktopCPPx86 OptionId.DesktopCPParm64"
)
...
$proc = Start-Process -FilePath $installer -ArgumentList "/features $Features /quiet /norestart /log `"$logPath`"" -Wait -PassThru
