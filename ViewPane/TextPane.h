...
public:
	...
	static TextPane* CreateMultiLinePane(UINT uidLabel, _In_ wstring const& szVal, bool bReadOnly);
	static TextPane* CreateSingleLinePane(UINT uidLabel, bool bReadOnly, bool bMultiLine = false);
	static TextPane* CreateSingleLinePane(UINT uidLabel, _In_ wstring const& szVal, bool bReadOnly, bool bMultiLine = false);
	...
	void AppendString(_In_ wstring const& szMsg);
