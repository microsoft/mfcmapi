...
namespace mapiprocessor
{
	...
	private:
		...
		void DoMessagePerRecipientWork(_In_ LPMESSAGE lpMessage, _In_ LPVOID lpData, _In_ const _SRow* lpSRow, ULONG ulCurRow) override;
		...
		void DoMessagePerAttachmentWork(_In_ LPMESSAGE lpMessage, _In_ LPVOID lpData, _In_ const _SRow* lpSRow, _In_ LPATTACH lpAttach, ULONG ulCurRow) override;
