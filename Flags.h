...
FLAG_ARRAY_ENTRY g_FlagArray[] =
{
	...
	NON_PROP_FLAG_ENTRY(flagContabIndex,EEI_EMAIL_1,flagVALUE)
	...
	NON_PROP_FLAG_ENTRY(flagMDBVersion,MAPIMDB_VERSION,flagVALUE)

	NON_PROP_FLAG_ENTRY(flagMDBFlag,MAPIMDB_NORMAL,flagVALUE)
};