...
FLAG_ARRAY_ENTRY g_FlagArray[] =
{
	...
	FLAG_ENTRY(PR_LAST_VERB_EXECUTED,NOTEIVERB_OPEN,flagVALUE)
	...
	NAMEDPROP_FLAG_ENTRY(dispidFileUnderList,PSETID_Address,PROP_ID(PR_COMPANY_NAME),flagVALUE)
	NAMEDPROP_FLAG_ENTRY(dispidFileUnderList,PSETID_Address,PROP_ID(PR_DISPLAY_NAME),flagVALUE)
	NAMEDPROP_FLAG_ENTRY(dispidFileUnderList,PSETID_Address,PROP_ID(PR_GIVEN_NAME),flagVALUE)
	NAMEDPROP_FLAG_ENTRY(dispidFileUnderList,PSETID_Address,PROP_ID(PR_SURNAME),flagVALUE)
